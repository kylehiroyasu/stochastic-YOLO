...
python train.py --data data/ccpd.data --epochs 50 --batch-size 16 --name ccpd_ensemble_4 --weights '' --cfg cfg/yolov3-custom-ccpd.cfg --img-size 640 --notest
python train.py --data data/ccpd.data --epochs 50 --batch-size 16 --name ccpd_ensemble_5 --weights '' --cfg cfg/yolov3-custom-ccpd.cfg --img-size 640 --notest
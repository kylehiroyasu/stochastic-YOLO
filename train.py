...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov3-ultralytics.pt', help='initial weights path')
    ...
    parser.add_argument('--ignore_model_epochs', action='store_true', help='to ignore the trained epochs from loaded model to calculate the new initial training epoch')
